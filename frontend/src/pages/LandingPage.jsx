...
const LandingPage = () => {
  useEffect(() => {
    ...
    const getSafetyTip = async () => {
      ...
      const prompt =
        "Ստեղծեք կիբերանվտանգության մեկ հակիրճ, դրական և հեշտ հասկանալի հուշում երեխայի կամ ծնողի համար՝ հայերեն: Դարձրեք այն հուսադրող: Օրինակ՝ 'Միշտ հարցրու մեծահասակին, նախքան նոր խաղ ներբեռնելը։'";
