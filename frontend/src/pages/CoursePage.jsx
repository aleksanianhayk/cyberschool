            ...
            <header className="w-full bg-white shadow-md sticky top-0 z-10 p-4">
                <div className="max-w-5xl mx-auto">
                    <div className="flex justify-between items-center">
                         <Link to="/learn" className="text-sm text-green-600 hover:underline sm:hidden">← Վերադառնալ</Link>
                         <h2 className="text-xl font-bold text-center sm:font-normal sm:text-base">{course.title}</h2>
