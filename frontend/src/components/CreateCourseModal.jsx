        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Դասընթացի վերնագիր</label>
                        <input
                            type="text"
                            value={title}
                    ...
                    <div className="mb-6">
                        <label className="block text-gray-700 font-medium mb-2">Course ID (auto-generated)</label>
                        <input
                            type="text"
