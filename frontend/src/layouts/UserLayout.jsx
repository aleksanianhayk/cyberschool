...
const CoursesIcon = ({ className }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M12 6.253v11.494m-5.747-8.994l11.494 0M4.753 12l14.494 0"
    />
  </svg>
);
const AskAiIcon = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`h-6 w-6 ${className}`}
    fill="none"
...
const UserLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <aside
        className={`relative z-30 flex flex-col bg-white shadow-xl transition-all duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="px-4 py-4 border-t">
          ...
          <button
            onClick={logout}
            className="flex items-center p-3 my-2 rounded-lg font-medium transition-colors text-red-600 hover:bg-red-100 w-full"
          >
